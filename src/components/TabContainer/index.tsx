      ...
      <div className="flex flex-wrap items-center justify-between bg-muted/50 border-b border-border h-8">
               ...
               return (
                 <div 
                    ...
                    className={cn(
                      ...
                      isSelected ? "bg-background font-medium border-t-primary h-8" : "hover:bg-background/50 text-muted-foreground border-t-transparent h-8"
                    )}
                 ...
                 >
                    ...
                    {files.length > 1 && (
                      <button
                        ...
                        title={confirmingDelete === file.name ? "Click again to confirm" : "Close file"}
                      >
        ...
        {(fileInfo || actions) && (
          <div className="flex items-center gap-2 px-3 border-l border-border flex-shrink-0">
            {fileInfo && <div className="text-xs text-muted-foreground whitespace-nowrap">{fileInfo}</div>}
